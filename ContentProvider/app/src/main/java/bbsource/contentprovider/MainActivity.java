...
public class MainActivity extends AppCompatActivity
    ...
    public  void addRecord (View view){
        ...
        if ((!((EditText) findViewById(R.id.name)).getText().toString().isEmpty()) && (!((EditText) findViewById(R.id.nivkname)).getText().toString().isEmpty())){
            values.put(CustomContentProvider.NAME, ((EditText) findViewById(R.id.name)).getText().toString());
            values.put(CustomContentProvider.NICK_NAME, ((EditText) findViewById(R.id.nivkname)).getText().toString());
    ...
    public void showAllRecords(View view){
        ...
        String URL = "content://com.androiodatc.provider/nicknames";
        ...
        if(!c.moveToFirst()){
            ...
            if (!result.isEmpty()) Toast.makeText(this, result , Toast.LENGTH_LONG).show();
